...
namespace završniRad.Controllers
{
    public class ProfesorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProfID,Ime,Prezime")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProfID,Ime,Prezime")] Profesor profesor)
        {
            if (ModelState.IsValid)
            {
